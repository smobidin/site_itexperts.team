+++
title = 'Архитектурный анализ межпроцессорной связи серверов на базе AMD 9005 и Intel 6700P'
description = 'Архитектурный анализ скорости межпроцессорных линий для процессоров Intel и AMD. Выбор оптимального решения для ИИ.'
date = 2026-02-12
draft = false
tags = ["HW", "PCIe", "GPU", "AI"]
...
![Switched](/img/pcie_switched.png)
