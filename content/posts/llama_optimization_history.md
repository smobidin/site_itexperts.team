...
description = 'Локальный инференс иногда нужен для решения моих задач. В рамках экспериментов добивался максимальной доступной мне производительности на ноутбуке. Без дискретного GPU.'
date = 2026-09-07
draft = false
tags = ["AI", "HW"]
