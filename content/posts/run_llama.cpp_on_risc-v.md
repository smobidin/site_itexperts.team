...
| Milk‑V        | Jupiter NX (SoM)                                         | SpacemiT K1/M1         | 8‑ядерный SoM на SpacemiT K1/M1, профиль RVA22, поддержка RVV 1.0, LPDDR4X, eMMC на модуле, совместим с базовыми платами Nano/Xavier NX; ISA: RV64IMAFDCH + B, V (RVV 1.0) по RVA22.+1                                                                                                                                                                                                                                                                                              | https://milkv.io/jupiter-nx         |
