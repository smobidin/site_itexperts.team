...
2. **МКС** гоняет по радиаторам аммиак. При нормальном давлении он замерзает при **-78°C**, но в системе давление выше, а у аммиака кривая плавления имеет положительный наклон — значит точка замерзания **поднимается** (до примерно -74°C). Для инженеров это серьёзный вызов: риск замерзания аммиака в трубах выше, а не ниже.
