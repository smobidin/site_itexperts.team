...
- **Звуковой предел** — скорость пара достигает скорости звука, поток «запирается» (choking), и перенос тепла фазовым переходом испарение→конденсация блокируется.
...
| **Кубсат (3U)**      | 20-35 Вт       | Пассивный радиатор — теневая двусторонняя грань (10×34 см ≈ 0.07 м²) |
